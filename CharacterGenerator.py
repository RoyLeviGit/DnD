    ...
    def __init__(self):
        ...
        self.spells = {
            "Intelligence": ["Acid Arrow", "Blindness/Deafness", "Continual Flame", "Darkness", "Detect Magic",
                      ...
                      "Phantom Steed", "Polymorph", "Scrying", "Sending", "Suggestion", "Telekinesis", "Telepathy",
                      "True Resurrection"],
            ...
            "Charisma": ["Animal Friendship", "Bane", "Bless", "Chaos Bolt", "Charm Person", "Command", "Compelled Duel",
                      "Compelling Argument", "Crown of Madness", "Cure Wounds", "Dancing Lights", "Darkness", "Daze",
                      "Death Knell", "Delay Poison", "Detect Thoughts", "Dimension Door", "Disguise Self",
                      "Disintegrate", "Divine Favor", "Eldritch Blast", "Enthrall", "Expeditious Retreat", "Fear",
                      "Friends", "Gaseous Form", "Geas", "Gust of Wind", "Heal", "Hold Person", "Inflict Wounds",
                      "Invisibility", "Lesser Restoration", "Locate Animals or Plants", "Locate Object", "Mage Armor",
                      "Magic Missile", "Magic Weapon", "Minor Illusion", "Mislead", "Misty Step", "Modify Memory",
                      "Nondetection", "Pass without Trace", "Polymorph", "Prayer of Healing", "Prestidigitation",
                      "Raise Dead", "Ray of Frost", "Remove Curse", "Remove Disease", "Resurrection", "Revivify",
                      "Scorching Ray", "Searing Smite", "See Invisibility", "Shield", "Shield of Faith", "Silence",
                      "Sleep"]
        }
